...
> 模板3正文配音请使用女声「清醒语录」。请用最终配音稿生成MP3和逐句对齐的SRT，然后将两个文件上传。
...
- 扁平手绘、知识科普风的人物情境插画，不生成风景图、纯静物图或抽象氛围图；
- 以一个主要人物或一组关系明确的人物为核心，通过动作、情绪和相关道具表达当前分镜文案；
- 同一期保持人物造型、线条和配色一致；
- 人物头部、手臂、手掌和手指数量正常，连接关系清楚，不得重复、融合、悬空或错位；
- 人物持有手机、书籍等道具时，手掌与道具的关系必须自然，不得穿插；
- 所有人物和道具组成紧凑的中央插画组，主体边缘完整并留出抠图安全空间；
- 先生成纯绿色抠图背景版本；
- 再移除绿色并导出透明RGBA PNG；
